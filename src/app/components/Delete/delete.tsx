      ...
      <div className="min-h-screen flex flex-col bg-white bg-fixed">
        ...
        <div
          ...
          style={{
            ...
            backgroundPosition:
              "bottom left, bottom left,top right, right, 50% 12%",
              backgroundSize: "13%, 18%, 13%, 12%,30%",
          }}>
          <form className="bg-white ml-5 mb-11 pb-16">
        <div className="mb-2">
          <label htmlFor="email" className="font-bold text-[32px] bg-grey text-lg  text-gray-900 mb-2 flex w-[130px] h-[52px] flex-col justify-center flex-shrink-0">
            Email
          </label>
          <input
            type="email"
        ...
        <p className="mt-4  text-gray-600">
          ...
          We will process the<br/> delete request as soon as possible.
        </p>
