...
import partner from "@/app/assets/Partnership.svg";
    ...
    return (
        <div className='name="viewport" content="width=device-width, initial-scale=1.0'>
            <div className="min-h-screen flex flex-col bg-white bg-fixed">
                ...
                <div
                    className="flex-1 flex flex-col items-center lg:justify-end md:justify-around justify-around w-full"
                    style={{
                        backgroundImage:
                            "url('/Ellipse1.svg'), url('/Ellipse4.svg')",
                ...
                >
                    <form
                        className="bg-white lg:w-[30%] md:w-[50%] w-[80%] p-4 sm:p-8 rounded-lg shadow-lg"
                    ...
                    >
                        ...
                        <p className="mt-4 text-gray-600 text-sm sm:text-base lg:text-xl">
                            Enter the email address associated with the account
                            you would like to delete. We will process the delete
                    ...
                    <Image
                        src={partner}
                        alt="partnership"
                        className="lg:w-[25%] md:w-[40%] w-[70%]"
                    />
                </div>
                {showPopup && (
                    <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center px-4 sm:px-0">
                        <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg text-center max-w-md w-full">
                            ...
                            <p className="mb-4 text-black">
                                Your form has been submitted. We shall process
                                your delete request soon.
                            </p>
                            <button
